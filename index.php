...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdni.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
...
<nav class="navbar navbar-inverse" style="background-color: #720031;">
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" style="background-color: #720031" href="#" >Articole <span class="caret"></span></a>
...
<!-- Begin page content -->
	...
	function set_body_height() { // set body height = window height
		...
		<!--<IMG STYLE="position:relative; TOP:10%; LEFT:70%; WIDTH:200px; HEIGHT:110px" SRC="d.png"></div> -->
<div class="container">
